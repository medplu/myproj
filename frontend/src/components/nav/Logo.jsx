...
const Logo = () => {
  return (
    <Link to="/landing" className="flex rounded-xl overflow-hidden">
      ...
      <div
        className="bg-blue-500 text-white text-sm flex items-center p-1"
        style={{ width: "calc(100% - 40px)", minHeight: "40px" }}
      >
        Medplus<sup>+</sup>
      </div>
    </Link>
