...
const PatientPage = ({ authUser }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-900 text-white">
      ...
      <div className="flex overflow-x-scroll gap-4 pb-4 hide-scroll-bar">
        {(filteredDoctors.length ? filteredDoctors : doctors).map((doctor) => (
          <div key={doctor._id} className="bg-gray-900 flex text-white p-4 rounded-lg items-center shadow-lg m-2 flex-shrink-0" style={{minWidth: '300px'}}>
            ...
            <div className="p-2 ml-4">
              ...
              <div className="inline-block">
                <p className="text-sm text-gray-600 flex items-center">
                  <MdLocationOn className="mr-1 text-blue-600 mb-4" /> {doctor.location}
                </p>
