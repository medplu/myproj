...
function DarkVariantCarousel() {
  ...
  const images = [
    ...
    "https://res.cloudinary.com/dws2bgxg4/image/upload/v1715661676/l4lremtb1xcbi4m9mwmo.jpg"
  ];
...
return (
  ...
  >
    {/* Carousel indicators */}
    <div
      className="absolute inset-x-0 bottom-0 z-[2] mx-[15%] mb-8 flex list-none justify-center p-0"
    ...
    <div className="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
      {[0, 1, 2].map((index) => (
        ...
        >
          ...
          <div className="absolute inset-x-[15%] bottom-5 py-5 text-center mb-20 text-white md:block">
    ...
    <button
      className="absolute bottom-0 left-0 top-0 z-[1] flex w-[15%] items-center shadow-xl justify-center border-0 bg-none p-0 text-center text-orange-500 opacity-50 transition-opacity duration-150 ease-[cubic-bezier(0.25,0.1,0.25,1.0)] hover:text-white hover:no-underline hover:opacity-90 hover:outline-none focus:text-white focus:no-underline focus:opacity-90 focus:outline-none motion-reduce:transition-none"
      type="button"
      onClick={handlePrev}
    >
      <span className="h-8 w-8 dark:grayscale">
        <svg
    ...
    <button
      className="absolute bottom-0 right-0 top-0 z-[1] flex w-[15%] items-center text-pink-50 shadow-lg justify-center border-0 bg-none p-0 text-center text-white opacity-50 transition-opacity duration-150 ease-[cubic-bezier(0.25,0.1,0.25,1.0)] hover:text-white hover:no-underline hover:opacity-90 hover:outline-none focus:text-white focus:no-underline focus:opacity-90 focus:outline-none motion-reduce:transition-none"
      type="button"
      onClick={handleNext}
    >
      <span className=" h-8 w-8 dark:grayscale">
